...
const Dashboard: React.FunctionComponent = () => {
  ...
  const renderParticipantsList = () => {
    if (
      ...
      currentProjectForParticipants.participants
    ) {
      return currentProjectForParticipants.participants.map(
        (participant, index) => (
          <div
            key={index}
            style={{
    ...
    <>
      ...
      {manageParticipantsOpen && currentProjectForParticipants && (
        ...
        >
          ...
          >
            <Button
              type="primary" /*block onClick={() => addNewParticipant()}*/
            >
          ...
          projects.map((project) => (
            <Col xs={24} sm={12} md={8} lg={6} xl={4} key={project.id}>
              ...
              >
                ...
                >
                  {new Date(project.created).toString()}
                </div>
              </Card>
            </Col>
          ))
