...
namespace UserService.DataAccess.Persistence
{
    ...
    //{
        ...
        public interface IRepository<T, TPrimaryKey> where T : IBaseEntity<TPrimaryKey>
        {
            /// <summary>
            ...
            /// <returns> Cущность. </returns>
            Task<T?> GetAsync(TPrimaryKey id, CancellationToken cancellationToken=default(CancellationToken));
