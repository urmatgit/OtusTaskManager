...
{
    public abstract class BaseRepository<T, TPrimaryKey> : IRepository<T, TPrimaryKey> where T  : class, IBaseEntity<TPrimaryKey>
    {
        ...
        {
            var enumerable = entities as IList<T> ?? [.. entities];
